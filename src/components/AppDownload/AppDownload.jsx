  ...
  return (
    ...
    >
      <div className="container overflow-visible">
        <div
          ref={cardRef}
          className="relative bg-primary-gb rounded-[28px] sm:rounded-[32px] lg:rounded-[36px] px-8 sm:px-14 lg:px-20 py-12 sm:py-16 lg:py-20 shadow-[0_20px_50px_rgba(14,82,255,0.22)] overflow-visible"
        >
          {/* Left Content */}
          <div className="relative z-10 max-w-[560px] text-left">
            <h2
              ref={headingRef}
              className="text-3xl sm:text-4xl lg:text-[44px] xl:text-[48px] font-black font-heading text-white leading-[1.18] tracking-tight"
            >
              Download <br /> Garibook Mobile App
            </h2>
            <p
              ref={subtitleRef}
              className="mt-4 sm:mt-5 text-base sm:text-lg lg:text-xl text-white/95 font-normal leading-relaxed max-w-[480px]"
            >
          ...
          <div
            ref={phoneRef}
            className="mt-10 lg:mt-0 flex justify-center lg:block lg:absolute lg:right-10 xl:right-20 lg:bottom-0 pointer-events-none z-10"
          >
            <img
